            ...
            <main className="max-w-4xl mx-auto px-6 py-20">
                <header className="mb-16">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-4 text-gray-500 text-sm font-medium">
                        ...
                        <p>Type: <span className="text-metamask-orange">User Statement</span></p>
                    </div>
                </header>
                ...
                <div className="space-y-16 prose prose-indigo max-w-none">
                    <section>
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            Cookies are small files stored on your device that help us improve your experience. They allow us
                            to remember your preferences, analyze site performance, and make sure our services run securely.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-gray-600 mb-6">We use specific third-party analytics tools to measure performance:</p>
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-between p-4 border border-metamask-gray-100 rounded-xl bg-metamask-gray-50 hover:bg-white transition-all group">
                                <div>
                                    ...
                                    <p className="text-xs text-gray-400 italic">Website usage statistics and user flows</p>
                                </div>
                                <div className="w-2 h-2 rounded-full bg-metamask-orange ring-4 ring-metamask-orange/10 animate-pulse"></div>
                            </div>
                        </div>
                    ...
                    <section className="bg-metamask-orange/5 border border-metamask-orange/10 p-8 rounded-2xl">
                        ...
                        <p className="text-gray-600 mb-6 leading-relaxed">
                            You can manage or disable cookies through your browser settings. Most browsers let you
                            block cookies or warn you when a cookie is sent. Note: disabling essential cookies may
                            affect the use of certain features.
                        </p>
                    ...
                    <section>
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            Note: interactions with Web3 wallets (e.g. Phantom, Solflare) do not use traditional HTTP
                            cookies. These wallets use local browser storage or secure enclaves to manage cryptographic
                            keys and state. VAIIYA has no access to your private keys through this storage mechanism.
                        </p>
                    </section>
                    ...
                    <section className="bg-metamask-purple p-10 rounded-[40px] text-center relative overflow-hidden group">
                        ...
                        <p className="text-purple-100 text-sm mb-8 max-w-sm mx-auto relative z-10">Have questions about our cookie use? Get in touch with our privacy team.</p>
