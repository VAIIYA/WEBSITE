        ...
        <div className="min-h-screen bg-white text-gray-900 font-sans selection:bg-metamask-orange/10">
            <main className="max-w-4xl mx-auto px-6 py-20">
                ...
                <div className="space-y-16 prose prose-indigo max-w-none">
                    <section>
                        <h2 className="text-2xl font-serif text-metamask-purple mb-6 border-l-4 border-metamask-orange pl-4">Account Deletion Request</h2>
                        <p className="text-gray-600 leading-relaxed text-lg">
                            We value your privacy and your right to be forgotten. If you want to stop using FYNDER and have your data
                            removed from our systems, you can request permanent account deletion.
                        </p>
                    </section>

                    <section className="bg-metamask-gray-50 border border-metamask-gray-100 p-8 rounded-[32px]">
                        <h2 className="text-2xl font-serif text-metamask-purple mb-6">What Gets Deleted?</h2>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            {[
                                { title: 'Profile Information', desc: 'Your name, age, bio, and all personal preferences.' },
                                { title: 'Photos', desc: 'All uploaded profile photos and private gallery images.' },
                                { title: 'Matches', desc: 'All active and past match connections with other users.' },
                                { title: 'Messages', desc: 'Your complete chat history across all conversations.' }
                            ].map((item, i) => (
                    ...
                    <section>
                        <h2 className="text-2xl font-serif text-metamask-purple mb-6 border-l-4 border-metamask-orange pl-4">How To Delete Your Account</h2>
                        <div className="space-y-6">
                            <div className="p-6 border border-metamask-gray-100 rounded-2xl bg-white hover:border-metamask-orange/20 transition-all">
                                <h3 className="font-bold text-metamask-purple mb-2">Option 1: Delete In-App</h3>
                                <p className="text-gray-600 text-sm">
                                    Open FYNDER &gt; Go to Profile Settings &gt; Security &amp; Privacy &gt; Tap &quot;Delete Account&quot;.
                                    This is the fastest method and processes your request immediately.
                                </p>
                            </div>
                    ...
                    <section className="bg-red-50 border border-red-100 p-8 rounded-2xl">
                        ...
                        <p className="text-red-800 text-sm leading-relaxed">
                            Account deletion is <strong>permanent and irreversible</strong>. Once processed, your profile cannot be restored.
                            Note that certain data may be retained for a limited period where legally required or for
                            legitimate safety purposes (e.g. preventing banned users from creating new accounts).
                        </p>
                    </section>
                    ...
                    <section className="text-center py-12 border-t border-metamask-gray-100">
                        ...
                        <p className="text-gray-500 text-sm mb-8">See our Privacy Policy for more details on how we handle user information.</p>
                        <div className="flex justify-center gap-4">
                            <a href="/en/privacy-policy" className="px-6 py-2 bg-metamask-gray-50 hover:bg-metamask-gray-100 rounded-lg text-sm font-bold text-metamask-purple transition-all">
                                View Privacy Policy
                            </a>
                        </div>
                    </section>
