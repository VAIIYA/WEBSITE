  ...
  return (
    <main className="min-h-screen bg-cream text-ink">
      ...
      <section className="relative pt-20 pb-16 bg-card border-b border-card-border overflow-hidden bg-dot-grid">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <p className="text-xl text-ink/70 leading-relaxed max-w-2xl">
            Fast, fun, and built to last — mobile games developed natively for Android and iOS, from core gameplay loop to store launch.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-card border-y border-card-border">
        <div className="max-w-4xl mx-auto text-center space-y-4">
          ...
          <p className="text-ink/70 leading-relaxed">
            We start with the core loop — the ten seconds of gameplay that have to feel right before anything else matters.
            From there we build native rendering, level and progression design, and store-ready QA passes so launch day has no surprises.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {games.length === 0 && (
            <p className="text-center text-ink/60">
              Our earlier games are no longer active. New game projects will show up here once they go live.
            </p>
          )}
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-2xl sm:text-3xl font-bold font-serif mb-4">Got an idea for a game?</h2>
