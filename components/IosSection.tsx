...
export default function IosSection() {
  ...
  return (
    <section id="ios" className="relative py-24 px-4 sm:px-6 lg:px-8 bg-transparent">
      <div className="max-w-7xl mx-auto relative z-20">
        ...
        <div className="backdrop-blur-md bg-white/80 p-8 sm:p-12 rounded-[40px] border border-gray-200 shadow-xl mb-12 text-center max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-900 text-white text-xs font-bold uppercase tracking-widest mb-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 mt-6">
            <span className="px-3 py-1 bg-slate-100 rounded-full text-xs font-medium text-slate-700">Swift 5</span>
            <span className="px-3 py-1 bg-slate-100 rounded-full text-xs font-medium text-slate-700">SwiftUI</span>
            <span className="px-3 py-1 bg-slate-100 rounded-full text-xs font-medium text-slate-700">Combine Framework</span>
            <span className="px-3 py-1 bg-slate-100 rounded-full text-xs font-medium text-slate-700">App Store Connect</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {iosApps.map((app) => (
            ...
            >
              {/* App Header Visual */}
              <div className={`relative h-60 bg-gradient-to-br ${app.gradient} p-8 flex flex-col justify-between overflow-hidden`}>
                <div className="absolute inset-0 bg-black/10 backdrop-blur-[2px]" />

                <div className="relative z-10 flex justify-between items-start">
                  <span className="px-3 py-1 rounded-full bg-slate-900/90 text-white text-[10px] font-bold uppercase tracking-wider shadow">
                    iOS NATIVE
                  </span>
                ...
                <div className="space-y-3 pt-4 border-t border-gray-100">
                  {app.appStoreUrl && (
                    <a
                      ...
                      className="w-full inline-flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-2xl bg-slate-900 hover:bg-black text-white font-semibold text-sm transition-all shadow-md hover:shadow-slate-900/30 active:scale-95"
                    >
