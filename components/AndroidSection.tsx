...
export default function AndroidSection() {
  ...
  return (
    <section id="android" className="py-24 px-4 sm:px-6 lg:px-8 bg-slate-50 relative">
      <div className="max-w-7xl mx-auto">
        
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-100 border border-emerald-200 text-emerald-800 text-xs font-bold uppercase tracking-widest">
            <span>🤖 CORE PILLAR • NATIVE ANDROID APPS</span>
          </div>

          <h2 className="text-4xl sm:text-5xl font-bold tracking-tight text-slate-900 font-serif">
            Native <span className="text-emerald-600 italic">Android</span> Applications
          </h2>

          <p className="text-slate-600 text-lg leading-relaxed font-normal">
            Engineered with Kotlin, Jetpack Compose, Coroutines, and Material 3 design systems. Optimized for top performance on all Android smartphones and tablets.
          </p>

          <div className="flex flex-wrap justify-center gap-2 pt-2">
            <span className="px-3 py-1 rounded-full bg-white border border-slate-200 text-xs font-medium text-slate-700">Kotlin Coroutines</span>
            <span className="px-3 py-1 rounded-full bg-white border border-slate-200 text-xs font-medium text-slate-700">Jetpack Compose</span>
            ...
            <span className="px-3 py-1 rounded-full bg-white border border-slate-200 text-xs font-medium text-slate-700">Material 3 UI</span>
          </div>
        </div>
                ...
                <div className="space-y-2 pt-4 border-t border-slate-100">
                  {app.playStoreUrl && (
                    <a
                      ...
                      className="w-full btn-metamask bg-emerald-600 text-white hover:bg-emerald-700 text-xs font-bold"
                    >
