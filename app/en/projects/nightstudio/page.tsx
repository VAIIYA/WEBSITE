...
export const metadata: Metadata = {
  title: 'NIGHTSTUDIO',
  description: 'NIGHTSTUDIO is an elite social layer for creators who value ownership. Gate your content, build your community, and receive instant Solana payouts.',
}

export default function NightStudioPageEn() {
    return (
            ...
            <section className="relative pt-24 pb-32 px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-b from-[#f9f5ff] to-white">
                <div className="max-w-7xl mx-auto relative z-10 text-center">
                    ...
                    <p className="text-xl text-gray-500 max-w-3xl mx-auto leading-relaxed mb-16">
                        NIGHTSTUDIO is an elite social layer for creators who value ownership. Gate your content, build your community, and receive instant Solana payouts with no middleman.
                    </p>
            ...
            <section className="py-32 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                        <div>
                            <h2 className="text-5xl font-serif mb-10 text-metamask-purple">Built For The Independent Creator.</h2>
                            <div className="space-y-12">
                                <div className="group">
                                    ...
                                    <p className="text-gray-500 text-lg">Advanced content-gating tools let you monetize your influence on your own terms.</p>
                                </div>
                                ...
                                <div className="group">
                                    <div className="flex items-center gap-4 mb-4">
                                        ...
                                        <h3 className="text-2xl font-serif">Instant Earnings</h3>
                                    </div>
                                    <p className="text-gray-500 text-lg">Payments settle instantly on Solana, with 400ms finality from fan to creator.</p>
                                </div>
                                ...
                                <div className="group">
                                    ...
                                    <p className="text-gray-500 text-lg">Build meaningful relationships through a platform that puts human interaction over algorithms.</p>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-24 bg-metamask-purple text-white relative overflow-hidden">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    ...
                    <p className="text-2xl text-purple-100 leading-relaxed italic mb-12">
                        &quot;At NIGHTSTUDIO, we believe premium software shouldn&apos;t just function — it should inspire. By pairing elite design with the power of Solana, we&apos;re setting a new standard for Web3 tools.&quot;
                    </p>
            ...
            <section className="py-32 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto bg-gradient-to-br from-metamask-gray-50 to-white border border-purple-50 rounded-[60px] p-12 md:p-24 text-center shadow-lg">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center">
                        ...
                        <Link href="/en/portfolio" className="btn-secondary px-12 py-5 text-lg">
                            View Portfolio
                        </Link>
                    </div>
                </div>
