      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="card-vibe">
            ...
            <h3 className="text-2xl font-serif mb-4 text-metamask-purple">{t('features.android.title')}</h3>
            <p className="text-gray-600 leading-relaxed">
              {t('features.android.description')}
            </p>
          </div>
          ...
          <div className="card-vibe">
            ...
            <h3 className="text-2xl font-serif mb-4 text-metamask-orange">{t('features.ios.title')}</h3>
            <p className="text-gray-600 leading-relaxed">
              {t('features.ios.description')}
            </p>
          </div>
          ...
          <div className="card-vibe">
            ...
            <h3 className="text-2xl font-serif mb-4 text-metamask-purple">{t('features.agentic.title')}</h3>
            <p className="text-gray-600 leading-relaxed">
