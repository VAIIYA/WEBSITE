...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'VAIIYA is a digital studio building powerful websites, native Android & iOS apps and mobile games.',
}
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="text-center">
                        <h1 className="text-5xl sm:text-7xl font-serif mb-8 leading-tight">
                            Builders Of High-Vibe <br />
                            <span className="text-metamask-orange">Websites, Apps &amp; Games.</span>
                        </h1>
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                            VAIIYA is a digital studio building powerful websites, native Android &amp; iOS apps and mobile games. We don&apos;t just write code; we craft experiences that feel great to use.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
                                <p>
                                    Every project starts with the same question: how should this feel to use? From there we design, build and launch &mdash; websites, native apps and mobile games &mdash; with the same obsessive attention to detail.
                                </p>
                                <p>
                                    We use modern tooling, including AI-assisted workflows, to move fast without cutting corners on quality. But the tools are just means to an end. What we ship gets judged on craft: does it feel fast, does it feel good, would we use it ourselves.
                                </p>
                            </div>
                        </div>
                ...
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="card-vibe p-10">
                            ...
                            <p className="text-gray-600">Native apps deliver buttery-smooth interactions and full access to device features for real-world impact.</p>
                        </div>
                        ...
                        <div className="card-vibe p-10">
                            ...
                            <p className="text-gray-600">One clear codebase vision, carefully maintained. Scalable architecture that grows with your product.</p>
                        </div>
            ...
            <section className="py-24 bg-metamask-purple text-white px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-xl text-purple-100 leading-relaxed mb-12">
                        &quot;We believe the future of software isn&apos;t just about functional utility, but about how it makes you feel. By pairing meticulous engineering with strong product intuition, we craft websites, apps and games that feel like magic.&quot;
                    </p>
            ...
            <section className="py-24 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    <div className="bg-metamask-gray-50 rounded-[40px] p-8 md:p-16 text-center border border-metamask-gray-100">
                        <h2 className="text-4xl font-serif mb-6">Ready to get involved?</h2>
                        <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
                            Browse our portfolio or get in touch to see how we can bring your app idea to life.
                        </p>
