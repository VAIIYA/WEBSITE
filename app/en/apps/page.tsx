...
export const metadata: Metadata = {
  title: 'Apps',
  description: 'Native Android & iOS apps built with Kotlin Jetpack Compose and Swift SwiftUI — shipped on the Play Store and App Store.',
}
...
export default function AppsPageEn() {
  return (
    <main className="min-h-screen bg-cream text-ink">
      ...
      <section className="relative pt-20 pb-16 bg-card border-b border-card-border overflow-hidden bg-dot-grid">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <p className="text-xl text-ink/70 leading-relaxed max-w-2xl">
            Built with Kotlin &amp; Jetpack Compose for Android, Swift &amp; SwiftUI for iOS. Shipped on the Play Store and App Store, engineered for real-world performance — not a demo build.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-card border-y border-card-border">
        <div className="max-w-4xl mx-auto text-center space-y-4">
          ...
          <p className="text-ink/70 leading-relaxed">
            ...
            wire up push notifications and analytics, and handle submission, review, and ongoing releases for the App Store &amp; Play Store.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {apps.length === 0 && (
            <p className="text-center text-ink/60">
              Our earlier apps are no longer active. New app projects will show up here once they go live.
            </p>
          )}
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-2xl sm:text-3xl font-bold font-serif mb-4">Got an idea for an app?</h2>
