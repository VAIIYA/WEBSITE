      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl sm:text-5xl font-serif mb-6">
            Our <span className="text-metamask-orange">Apps</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            A showcase of the apps we&apos;ve designed, built, and shipped. Each project reflects our commitment to innovation and clean code.
          </p>
        </div>
